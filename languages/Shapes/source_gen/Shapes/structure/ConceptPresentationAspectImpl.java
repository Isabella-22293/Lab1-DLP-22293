...
public class ConceptPresentationAspectImpl extends ConceptPresentationAspectBase {
  ...
  private ConceptPresentation props_Shapes;
    ...
    switch (structureDescriptor.internalIndex(c)) {
      ...
      case LanguageConceptSwitch.ColorReference:
        if (props_ColorReference == null) {
          ConceptPresentationBuilder cpb = new ConceptPresentationBuilder();
          cpb.presentationByReference(0xab3f66767593453fL, 0x964cd4f83092d6ebL, 0x43d844e9053d25afL, 0x43d844e9053d25b0L, "target", "", "");
          props_ColorReference = cpb.create();
        }
        return props_ColorReference;
      case LanguageConceptSwitch.Shapes:
        if (props_Shapes == null) {
          ConceptPresentationBuilder cpb = new ConceptPresentationBuilder();
          props_Shapes = cpb.create();
        }
        return props_Shapes;
